...
<html lang="pt-br">
	...
	<body>
		...
		$result_usuarios = "SELECT * FROM imagens LIMIT $inicio, $qnt_result_pg";
		...
		while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
			...
			echo "Imagem: " . $row_usuario['imagem'] . "<br><hr>";
	       	echo "<img src='" . imagens . '/' . $row_usuario['id'] .'/'. $row_usuario['imagem'] . "' style='width: 50px; height:50px;'>"; 
		...
		$result_pg = "SELECT COUNT(id) AS num_result FROM imagens";
